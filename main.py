...
def update_an_item(item_id: int, item: Item):
    ...
    item_to_update.guardian = item.guardian
    item_to_update.dob = item.dob
    item_to_update.gender = item.gender
    item_to_update.address = item.address
